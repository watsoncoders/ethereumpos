...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s etherumpos-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  etherumpos-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded etherumpos transaction") + "\n" +
              "  etherumpos-tx [options] -create [commands]   " + _("Create hex-encoded etherumpos transaction") + "\n" +
              "\n";
