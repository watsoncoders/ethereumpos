 ...
 * between etherumposd, and etherumpos-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("etherumpos-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/watsoncoders/ethereumpos>";
    const std::string URL_WEBSITE = "<https://etherumposcoin.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The EtherumPos Developers", 2023)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find EtherumPos useful. "
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("etherumpos-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("EtherumPos More version %s\n", FormatFullVersion());
}
