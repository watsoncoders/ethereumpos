...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"etherumposaddress\"\n"
            "\nReveals the private key corresponding to 'etherumposaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"etherumposaddress\"   (string, required) The etherumpos address for the private key\n"
            "\nResult:\n"
