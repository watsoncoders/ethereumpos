...
const QString BITCOIN_IPC_PREFIX("etherumpos:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/etherumpos-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/etherumpos-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/etherumpos-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click etherumpos: links
...
//
// OSX-specific way of handling etherumpos: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in etherumpos: URIs
