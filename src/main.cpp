...
#if defined(NDEBUG)
# error "EtherumPos cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "EtherumPos Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("etherumpos-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // EtherumPos also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // EtherumPos also requires low S in sigs
