...
unlocked to sign the EtherumPos-Qt.app bundle.
...
allowing somebody to distribute a EtherumPos-Qt.app or etherumpos-qt-setup.exe with a valid
...
that the etherumpos-qt.exe file inside the installer had not been tampered with.
